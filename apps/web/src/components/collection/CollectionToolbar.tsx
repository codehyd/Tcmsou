...
export function CollectionToolbar({
  ...
  return (
    <div className="flex w-full min-w-0 max-w-full flex-col gap-2 lg:flex-row lg:flex-wrap lg:items-center lg:justify-between lg:gap-4">
      {/* 搜药框占满一行；超宽屏加个上限，避免搜索框拉成跑道，下拉靠右站着 */}
      <div className="relative w-full min-w-0 flex-1 lg:max-w-xl 3xl:max-w-2xl">
        ...
        <Input
          ...
          className="h-9 rounded-sm bg-white/5 pl-8 text-base md:h-8"
        />
      </div>
